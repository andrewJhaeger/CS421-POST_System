...
/**
 * This class is used to manage a collection of product specifications for the
 * POST system
 */
public class ProductCatalog {
  ...
  /**
   * Populates the collection according to data in a text file with an item's
   * id, description, and price separated by a comma.
   *
   * @param file
   */
  ...
  /**
   * Returns a ProductSpecification for a given ID and throws an exception if
   * one is not found.
   *
   * @param itemID
  ...
  public ProductSpecification getProductSpec(int itemID) {
    ...
    throw new IllegalArgumentException(String.format(
            "Item with id %d not found in catalog", itemID));
  }
}
